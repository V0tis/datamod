-- upsert_country_trends: title_ko, news_items_ko 반영
...
BEGIN
  ...
  IF jsonb_array_length(p_rows) > 0 THEN
    ...
    SELECT
      ...
      (e->>'title_ko')::text,
      COALESCE(e->'news_items_ko', '[]'::jsonb),
...
COMMENT ON FUNCTION upsert_country_trends(text, jsonb) IS '국가별 트렌드 캐시: DELETE 후 INSERT. p_rows에 title_ko, news_items_ko 포함';
