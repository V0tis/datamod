    ...
    >
      <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        <div className="min-w-0 space-y-2">
          <p className="text-[11px] font-semibold uppercase tracking-wider text-slate-500 ">오늘의 시장 보드</p>
          <h1
            id="dash-hero-title"
            className="text-[1.35rem] font-bold leading-snug tracking-tight text-slate-900 sm:text-2xl "
          >
            환영합니다,{' '}
            ...
            님.
            <span className="mt-1 block text-base font-semibold text-slate-800 sm:mt-2 sm:text-lg ">
              오늘 Datamod가 포착한 핵심 시장 시그널입니다.
            </span>
          </h1>
          <p className="max-w-2xl text-sm leading-relaxed text-slate-600 ">
            총{' '}
            <strong className="font-bold tabular-nums text-emerald-600 ">{strongOppCount}</strong>
            개의 고기회 시장과{' '}
            <strong className="font-bold tabular-nums text-red-600 ">{strongRiskCount}</strong>
            개의 고리스크 시장이 감지되었습니다.
          </p>
        </div>
        <div
