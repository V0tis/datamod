...
export interface AnalysisProgressStepsProps {
  /** 0-based current step index. -1 = not started. */
  currentStep: number
  /** Map streaming step IDs to our step indices */
  stepMap?: Record<string, number>
  streamingStepId?: string
  className?: string
}

/** Maps runResearch event types to PM progress step indices */
